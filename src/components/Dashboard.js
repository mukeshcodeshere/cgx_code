...
import NewsFeed from "./NewsFeed"; // Corrected import
import Watchlist from "./Watchlist"; // Corrected import
import ProfitLossCalculator from "./ProfitLossCalculator"; // Corrected import
    ...
    <>
      {!completed ? (
        ...
        <>
          ...
          <div className="py-4 px-4 bg-gradient-to-r from-gray-800 to-gray-900">
            <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-4 sm:grid-cols-1 gap-2">
              <div className="md:col-span-3 grid-cols-3 sm:grid-cols-3 container-fluid">
                ...
                <NewsFeed /> {/* News Feature */}
              </div>
              <div className="col-span-1">
                <SideBar />
                <Watchlist /> {/* Watchlist Feature */}
                <ProfitLossCalculator /> {/* Profit/Loss Calculator */}
              </div>
            </div>
            <Footer />
          </div>
